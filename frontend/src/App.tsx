...
function App() {
  ...
  const [currentView, setCurrentView] = useState<'team' | 'athlete' | 'comparison' | 'trainingLoad' | 'recoveryTimeline' | 'predictive' | 'whoopStress' | 'userManagement' | 'weatherTest'>('team');
  ...
  const handleNavClick = (view: 'team' | 'comparison' | 'trainingLoad' | 'recoveryTimeline' | 'predictive' | 'whoopStress' | 'userManagement' | 'weatherTest') => {
    setCurrentView(view);
  };
